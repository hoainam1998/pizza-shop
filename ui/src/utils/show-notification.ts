...
*/
const showSuccessNotification = (title: string, messages?: string | string[], options?: any): void => {
  showNotification({
    title,
    type: 'success',
    message: messages,
...
* @param {object} options - The another options.
*/
const showErrorNotification = (title: string, messages?: string | string[], options?: any): void => {
  showNotification({
    title,
    type: 'error',
    message: messages,
...
* @param {object} options - The another options.
*/
const showInfoNotification = (title: string, messages?: string | string[], options?: any): void => {
  showNotification({
    title,
    type: 'info',
    message: messages,
